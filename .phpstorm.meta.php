...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/adityaalifsantoso/kuliah/rshp/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/adityaalifsantoso/kuliah/rshp/public/storage','logging.default',
...
'web','api',);
        registerArgumentsSet('routes', 'login.show','login','register.show',
'register','logout','admin.dashboard','admin.users','admin.users.create',
'admin.users.store','admin.users.edit','admin.users.update','admin.users.destroy','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.users.index','auth.login','auth.register','home',
'layouts.app','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button','laravel-exceptions-renderer::components.editor',
